...
if {![empty_string_p $portal_id]} {
    if {[portal::page_count -portal_id $portal_id] > 1} {
        ...
        append navbar [portal::list_pages -portal_id $portal_id -link "foobarlink" -pre_html "<td><font face=arial,helvetica size=-1 color=black><b> <center>" -separator " </center></td> <td><font face=arial,helvetica size=-1 color=black><b> <center>" -post_html "</a></center></td>"]
